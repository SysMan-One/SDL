...
#line 9 "parser.y" /* glr.c:240  */

/* your top code here */

#line 58 "parser.c" /* glr.c:240  */
...
{
  "$end", "error", "$undefined", "LPAREN", "RPAREN", "$accept",
  "document", "exprs", "expr", "parens", YY_NULLPTR
};
#endif
